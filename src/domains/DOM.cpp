...
$execute {
  auto p = Protocol::get();
  p->registerFunction("DOM.describeNode", &DOM::describeNode);
  p->registerFunction("DOM.disable", &DOM::disable);
  p->registerFunction("DOM.enable", &DOM::enable);
  p->registerFunction("DOM.getAttributes", &DOM::getAttributes);
  p->registerFunction("DOM.getAttribute", &DOM::getAttribute);
  p->registerFunction("DOM.getBoxModel", &DOM::getBoxModel);
  p->registerFunction("DOM.getDocument", &DOM::getDocument);
  p->registerFunction("DOM.getNodeForLocation", &DOM::getNodeForLocation);
  p->registerFunction("DOM.removeAttribute", &DOM::removeAttribute);
  p->registerFunction("DOM.setAttribute", &DOM::setAttribute);
}
